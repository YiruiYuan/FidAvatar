...
from train.optim        import register_optimizer_group_fidavatar
from train.iteration    import iteration_step_fidavatar
from train.deserialize  import deserialize_checkpoints_fidavatar
...
class Trainer(BaseTrainer):
    def __init__(
        ...
        self.optimizer_callbacks_hooks = {
            'FidAvatar':           register_optimizer_group_fidavatar
        }

        self.iteration_callbacks_hooks = {
            'FidAvatar':           iteration_step_fidavatar
        }

        self.deserialize_callbacks_hooks = {
            'FidAvatar':           deserialize_checkpoints_fidavatar
        }
    ...
    def train_epoch(self):
        ...
        elif self.model_name in ['FidAvatar', 'SplattingAvatar', 'GaussianAvatars']:
