...
class CompletionTrainer(Trainer):
    ...
    def render_dynamic_fixed_view(self, name=None, mode=None, num_views=12):
        ...
        with torch.no_grad():
            ...
            render_videos = [[] for _ in range(num_views)]

            camera_positions = [
                (view_idx + 1) / num_views for view_idx in range(num_views)
            ]
