...
def file_backup(workspace, config_path):
    ...
    dir_lis = ['./tools', './train', './flame', './rendering']
    file_lis = ['./common.py', './fidavatar.py', './mesh_rendering.py', './train.py']
    ...
    for file_name in file_lis:
        if os.path.exists(file_name):
            copyfile(file_name, os.path.join(workspace, 'archive', os.path.basename(file_name)))
